...
<img src="https://github.com/layzyidiot/e-sw/blob/main/images/1a76e3f8-5149-40c7-ae15-0881c45de244.png?raw=true" alt="Room Hierarchy" width="30%" height="30%"></img>

Create as many waves as you want in `Stuff` and add the `Activate Next Wave` component on all of them.

Place immovable/static objects such as room geometry into `Non Stuff`.
