...
<div style={{textAlign: 'right'}}>
    <img src={require('./assets/LevelStructure.png').default} width='20%'></img>
</div>
...
<div style={{textAlign: 'right'}}>
    <img src={require('./assets/NonStuff.png').default} width='20%'></img>
</div>
...
<div style={{textAlign: 'right'}}>
    <img src={require('./assets/Stuff.png').default} width='20%'></img>
</div>