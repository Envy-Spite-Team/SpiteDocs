...
If you used the statsmanager prefab from the [Basic Scene Setup](../../Setup/Scene%20Setup/index.mdx), it should be already set, and all you have to do is make `MusicChanger` triggers. But before that, let's explain each field of `MusicManager`.
...
Finally, we are going to explain how to change and play music in your levels.
