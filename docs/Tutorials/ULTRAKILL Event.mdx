...
This is an example where the Player gets teleported when the [Object Activator](Object%20Activator.mdx)'s ULTRAKILL Event is triggered.
...
Notably used in:
- [Object Activator](Object%20Activator.mdx)
- Variable Watchers
